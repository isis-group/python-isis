...
class TestNDimensional(unittest.TestCase):
	...
	def test_get_fov(self):
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(0,0,0,0) )[0] == 50 )
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(0,0,0,0) )[1] == 100 )
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(0,0,0,0) )[2] == 50 )
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(0,0,0,0) )[3] == 5 )
		
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(1,1,1,1) )[0] == 149 )
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(1,1,1,1) )[1] == 299 )
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(1,1,1,1) )[2] == 149 )
		self.assertTrue( self.ndim.getFoV( util.fvector4(0.5,0.5,0.5,0.5), util.fvector4(1,1,1,1) )[3] == 14 )
